function [pop] = IDBPI(lb, ub, init_popsize, dim, run)
 
    algRand = RandStream.create('mt19937ar','seed', run); % 将run设置为随机种子
    ...
    pop_I = pop;
    init_pop_path=sprintf("./IDBPI_POP/Init_Pop_Dim%02d_Run%02d",dim,run);
    save(init_pop_path,"pop_I");
end